...
Default_dataset_dir = "/home/anastasia/segmap_machine_learning_project-master/dataset18/"
...
class Dataset(object):
    ...
    def __init__(
        ...
        self.folder = Default_dataset_dir
    ...
    def load(self, preprocessor=None):
        from import_export import load_segments, load_positions, load_features
        ...
        # load labels
        from import_export import load_labels
        ...
        if self.use_merges:
            from import_export import load_merges
