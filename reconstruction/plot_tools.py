...
def plot_segment_input_voxelbox(voxelbox):
...
def plot_save_segment_input_voxelbox(voxelbox, index):
        ...
        for ii in np.arange(0,360,36):
            ax1.azim = ii
            plt.savefig("input_pictures/" + str(index) + "car%d.png" % ii)

        plt.show()


def plot_segment_reconstructed_voxelbox(voxelbox):
...
def plot_save_segment_reconstructed_voxelbox(voxelbox, index):
    ...
    for ii in np.arange(0, 360, 36):
        ax1.azim = ii
        plt.savefig("reconstructed_pictures/" + str(index) + "car%d.png" % ii)

    plt.show()


def plot_segment_input_voxelboxes(voxelboxes):
